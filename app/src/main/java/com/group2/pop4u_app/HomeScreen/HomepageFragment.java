...
//        loadProductOfWeek();
    ...
    private void loadData() {
        CompletableFuture<ArrayList<Product>> newProductFuture = ProductService.instance.getListProduct(1, "new", "asc", 10, 0, "", null, null);
        CompletableFuture<ArrayList<Product>> saleProductFuture = ProductService.instance.getListProduct(1, "sale", "desc", 10, 0, "", null, null);
